...
public class GetTenantDeviceTokensQueryHandler : IRequestHandler<GetTenantDeviceTokensQuery, List<DeviceTokenDto>>
{
    ...
    private readonly ILogger<GetTenantDeviceTokensQueryHandler> _logger;

    public GetTenantDeviceTokensQueryHandler(
        IDeviceTokenRepository deviceTokenRepository,
        ILogger<GetTenantDeviceTokensQueryHandler> logger)
    {
    ...
    public async Task<List<DeviceTokenDto>> Handle(GetTenantDeviceTokensQuery request, CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "An error occurred while getting tenant device tokens");
