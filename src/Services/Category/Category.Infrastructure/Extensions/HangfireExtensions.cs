using Category.Infrastructure.Jobs;
using Hangfire;
...
{
    public static IServiceCollection AddCategoryHangfire(
        ...
        services.AddHangfire((sp, config) =>
        {
            ...
            config
                ...
                .UsePostgreSqlStorage(options =>
                    ...
                    new PostgreSqlStorageOptions { SchemaName = "hangfire_category" });
        });

        services.AddHangfireServer(options =>
        {
            options.ServerName = "category-hangfire";
    ...
    public static IApplicationBuilder UseCategoryHangfireDashboard(
        this IApplicationBuilder app,
        IConfiguration configuration)
    {
        app.UseHangfireDashboard("/admin/jobs/category", new DashboardOptions
        {
    ...
    public static void RegisterCategoryRecurringJobs()
    {
