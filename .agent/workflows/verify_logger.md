---
description: Verify if an existing file is using ILogger correctly based on the application's logging standards.
---
...
4.  **Actionable Outcome**:
    - If any violations are found, fix them directly modifying the source code.
