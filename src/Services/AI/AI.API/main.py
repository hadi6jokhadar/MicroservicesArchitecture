...
from api.routes import transcription as transcription_router
...
app.include_router(transcription_router.router, prefix="/api/v1/transcription", tags=["Transcription"])
